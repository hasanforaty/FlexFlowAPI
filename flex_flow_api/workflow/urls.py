...
from workflow.views import WorkflowViewSet, NodeViewSet, EdgeViewSet, MessageViewSet
...
router.register("(?P<workflow_pk>[^/.]+)/messages", MessageViewSet, basename="message")
